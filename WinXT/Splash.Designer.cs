namespace Cselian.Utilities.WinXT
{
	partial class Splash
	{
		...
		private void InitializeComponent()
		{
			...
			this.lblMail.Size = new System.Drawing.Size(120, 14);
			this.lblMail.TabIndex = 7;
			this.lblMail.TabStop = true;
			this.lblMail.Text = "imran@cselian.com";
			...
			this.lblMsg.Text = "Win XT is absolutely FREE!\r\n(c) 2010 - {0} - All Rights Reserved.";
